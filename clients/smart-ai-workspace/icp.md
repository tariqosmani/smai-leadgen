...
Source: `../Smart_AI_Workspace_Website/src/lib/data/industries.ts` + the qualification
signals in `offer.md` (Pricing method §1). Keep this file in sync when the website's
...
## Qualification signals (from `offer.md` Pricing method §1) — score at `/lead-find`, confirm on the call
